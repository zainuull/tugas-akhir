...
import { mockInjection } from '../../../data/mockInjection';
...
export default function ListInjection() {
  const [user] = useUser();
  ...
  const handleDetail = (id: number) => {
    router.push(`detail/injection/${id}`);
  };
              ...
              {visibleRows.map((row, index) => {
                ...
                return (
                  <TableRow
                    ...
                    <TableCell align="center">{row.injection_time}</TableCell>
                    <TableCell align="center">{row.total_card}</TableCell>
